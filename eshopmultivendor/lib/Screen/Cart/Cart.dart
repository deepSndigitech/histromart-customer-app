...
/*    String orderId = DateTime
  ...
  void initPhonePeSdk({required String orderId}) async {
    // check here
    print("Phone pe mode ${context.read<CartProvider>().phonePeMode}");
    context.read<CartProvider>().phonePeMode = "UAT";
  ...
  void startPaymentPhonePe({required String orderId}) async {
    try {
      ...
      final jsonData = {
        "merchantId": context.read<CartProvider>().phonePeMerId,
        "merchantTransactionId": uuid,
        "amount": num.parse(amt).toInt(),
        "redirectUrl": context.read<CartProvider>().phonePeEndPointUrl,
        "redirectMode": "REDIRECT",
        "callbackUrl": context.read<CartProvider>().phonePeEndPointUrl,
      ...
      String dataToHash = base64Data +
          apiEndPoint +
          context.read<CartProvider>().phonePeSaltKey!;
      String sHA256 = generateSha256Hash(dataToHash);
      checksum = '$sHA256###${context.read<CartProvider>().phonePeSaltIndex}';
      ...
      PhonePePaymentSdk.startPGTransaction(
              body,
              context.read<CartProvider>().phonePeEndPointUrl!,
              checksum,
              pgHeaders,
              apiEndPoint,
