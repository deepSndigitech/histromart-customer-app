...
extension colors on ColorScheme {
  ...
  static MaterialColor primary_apps2 = const MaterialColor(
    0xFFe8e8e8,
    <int, Color>{
      50: back,
      100: back,
  ...
  static const Color back = Color(0xFFe8e8e8);
  static const Color fourth = Color(0xFFc44a37);
  static const Color third = Color(0xFFB4D4FF);
